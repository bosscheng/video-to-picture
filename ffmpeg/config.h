...
#define FFMPEG_CONFIGURATION "--extra-cflags='-c -Oz -fPIC' --cc=emcc --cxx=em++ --ar=emar --ranlib=emranlib --prefix=../obj --target-os=none --arch=x86_64 --cpu=generic --disable-everything --disable-all --disable-avdevice --disable-avformat --disable-postproc --disable-avfilter --disable-programs --disable-asm --disable-parsers --disable-muxers --disable-demuxers --disable-filters --disable-doc --disable-devices --disable-network --disable-bsfs --disable-shared --disable-hwaccels --disable-debug --disable-protocols --disable-indevs --disable-outdevs --disable-runtime-cpudetect --enable-small --enable-cross-compile --enable-gpl --enable-avcodec --enable-swresample --enable-pthreads --enable-ffmpeg --enable-parser=h264 --enable-parser=hevc --enable-parser=aac --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=aac --enable-decoder=pcm_alaw --enable-decoder=pcm_mulaw --enable-encoder=pcm_alaw --enable-encoder=pcm_mulaw --enable-encoder=aac --enable-static"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "../obj/share/ffmpeg"
#define AVCONV_DATADIR "../obj/share/ffmpeg"
#define CC_IDENT "emcc (Emscripten gcc/clang-like replacement + linker emulating GNU ld) 2.0.14"
#define OS_NAME none
